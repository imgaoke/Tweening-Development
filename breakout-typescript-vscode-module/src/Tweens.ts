...
export default class Tweens {
    ...
    public tween(target, property: string, targetValue: number, isEase:boolean, isSpline: boolean, timeSecs: number, func : (t: number) => number, on_end : (t: Tween) => void, uSpeed, first, second, third) : Tween {
